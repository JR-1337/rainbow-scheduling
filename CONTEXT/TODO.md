...
- **Sweep "scheduling envelope" jargon out of chatbot + memory.** JR caught chatbot answer 2026-04-26 s026: "Sarvi's 14-hour weekly scheduling envelope gets automated..." -- opaque term leaking into customer-facing answers. Phrase is in `api/ask-rainbow.js` FACT 3 + project_otr_facts auto-memory + DECISIONS L102. Replace with plain language ("scheduling work" / "scheduling time" / "the time Sarvi spends on the schedule"). Explicitly parked for "the other side of handoff."
