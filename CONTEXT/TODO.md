...
- **JR raised end-of-s032: unpaid-break logic.** Staff currently aren't paid for break time, but the schedule treats shift hours as gross. Need: shift model option for break duration (paid vs unpaid), payroll-roll-up subtracts unpaid breaks. Discuss next session before scoping.
