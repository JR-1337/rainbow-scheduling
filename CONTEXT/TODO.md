...
- Adversarial audit Phase E -- next: continue cracking open App() body. 3 hook-extract cuts (15-17: useUnsavedWarning, useDismissOnOutside, useAuth) shipped + 3 latent missing-import fixes (PAY_PERIOD_START, Logo, StaffingBar) shipped. App.jsx 3228 -> 3207 lines. Sub-area 6 still parked.
