...
- Adversarial audit Phase E -- next: crack open the main App() component body (~3000 lines remaining). Standalone top-of-file components exhausted: 7 more cuts shipped this session (LoginScreen, ColumnHeaderEditor, TooltipButton, ScheduleCell, dead enums, getStoreHoursForDate relocate, EmployeeRow). App.jsx down to 3228 lines (-474 / -13% this session, -919 / -22% across both sessions). Sub-area 6 (ref-elimination Context refactor) still parked -- now isolated to src/utils/storeHoursOverrides.js.
