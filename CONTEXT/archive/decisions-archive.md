...
## 2026-04-26 -- Migration off Sheets must preserve Sarvi's direct-edit workflow (Superseded by 2026-04-29 (s042) Migration shape: DB-canonical, Sheet = read-only mirror; admin UI is the edit surface)
...
Moved: 2026-04-27 (s028) -- 3 PK entries archived; shipped + verified, 6-month opportunistic stale review acceptable.
...
## 2026-04-26 -- $497/mo recurring is an open retainer; hosting passed through; 12-mo continuity contract on offer (Superseded)
...
Superseded by: 2026-04-26 (s026) -- Recurring fee scope reframed as operational care (active DECISIONS.md).
Rejected alternatives:
...
Superseded by: 2026-04-26 -- Pitch chatbot v4: Sonnet 4.6 + extended thinking (active DECISIONS.md).
...
## Pre-schema legacy: Rejected approaches (no per-entry date)

The following bullets pre-date the per-entry DECISIONS template and have no date heading. Retained for learning value (why each approach was attempted and abandoned):
