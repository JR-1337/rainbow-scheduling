...
Historical but inactive material with residual learning value.

## Contents

- `2026-04-s42-functional-audit.md` -- S42 pre-demo functional test sweep (46/52 PASS, 3 ROUGH). Useful when planning future audit cycles or investigating a regression in any of the covered surfaces.
