...
import { 
  ...
  Loader, ArrowRightLeft, ArrowRight, Bell, Menu 
} from 'lucide-react';
...
// ═══════════════════════════════════════════════════════════════════════════════
export const MobileMenuDrawer = ({ isOpen, onClose, currentUser, onLogout, onOpenShiftChanges, adminContacts = [], children }) => {
            ...
            {sortedEmployees.map(emp => {
              ...
              return (
                <tr key={emp.id}>
                  ...
                  <td style={{ 
                    width: NAME_COL_WIDTH, minWidth: NAME_COL_WIDTH,
                    backgroundColor: isMe ? THEME.accent.purple + '18' : THEME.bg.secondary,
                    borderRight: `1px solid ${THEME.border.default}`,
                  ...
                  {dates.map((date, i) => {
                    ...
                    return (
                      <td key={i} style={{ 
                        ...
                        backgroundColor: isMe ? THEME.accent.purple + '08' : THEME.bg.secondary,
                        borderBottom: `1px solid ${THEME.border.subtle}`,
                        padding: '2px'
                      }}>
